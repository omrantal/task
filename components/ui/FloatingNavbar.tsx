  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-lg h-16 fixed top-10 inset-x-0 mx-auto border border-transparent dark:border-sahara rounded-full dark:bg-codgray bg-white shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-2 pl-8 py-2 items-center justify-between",
          className
        )}
      >
        <div className="border text-sm font-medium relative border-neutral-200 dark:border-codgray text-black dark:text-white rounded-full">
          <Image
            ...
            height="50"
            width="50"
            className="w-16 h-12 rounded-full group-hover/card:shadow-xl"
            alt="thumbnail"
          />
          <span className="absolute inset-x-0 w-12 mx-auto -bottom-px bg-gradient-to-r from-transparent via-saffron to-transparent h-px" />
        </div>
